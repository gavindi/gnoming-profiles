...
### Changed
- Added GNOME Shell 51 support — extension is fully compliant with GNOME 51 changes (no code changes required; only the shell-version list updated)
- Bumped metadata version to 36
