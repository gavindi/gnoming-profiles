...
class PanelIndicator extends PanelMenu.Button {
    ...
    showChangeDetected() {
        ...
        this._changeDetectedTimeout = GLib.timeout_add(GLib.PRIORITY_DEFAULT, 1500, () => {
    ...
    showETagEfficiency() {
        ...
        // Remove the class after animation
        this._etagEfficiencyTimeout = GLib.timeout_add(GLib.PRIORITY_DEFAULT, 2000, () => {
     ...
     */
    destroy() {
        log('Panel Indicator: Starting cleanup');
        ...
        log('Panel Indicator: Cleanup complete');
