...
class PanelIndicator extends PanelMenu.Button {
    ...
    _createMenu() {
        ...
        let pollingItem = new PopupMenu.PopupMenuItem(_('Remote polling: Off'));
    ...
    updatePollingStatus(isPolling, intervalMinutes) {
        if (isPolling) {
            this._pollingItem.label.text = _(`Remote polling: Every ${intervalMinutes} min (ETag)`);
            this._icon.add_style_class_name('monitoring-active');
        } else {
            this._pollingItem.label.text = _('Remote polling: Off');
            this._icon.remove_style_class_name('monitoring-active');
        }
    }
    ...
    showRemoteChanges(commit) {
        ...
        if (commit && commit.sha) {
            ...
            this._remoteChangesItem.label.text = _('⬇ Pull Remote Changes');
        }
