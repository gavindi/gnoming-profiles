...
export class GitHubAPI {
     ...
     * @param {boolean} expectRaw - Whether to expect raw content instead of JSON
     * @returns {Promise<Object>} Response object
     */
    async makeRequest(url, method, token, data = null, etag = null, expectRaw = false) {
        return this.requestQueue.add(() => this._performRequest(url, method, token, data, etag, expectRaw));
    }
